...
export function TierBar() {
  ...
  return (
    <div className="sticky top-0 z-40 flex flex-wrap items-center justify-between gap-2 border-b border-[var(--ld-purple-dim)]/30 bg-[var(--ld-black)]/90 px-4 py-2 backdrop-blur">
